...
const ROUTES_BY_ROLE = {
    'superadmin': [
        ...
        { path: '/super-admin-dashboard/review-tracking', name: 'Review Tracking', icon: <FileText size={16} />, category: 'resources' },
        { path: '/super-admin-dashboard/dispatch-kpi', name: 'Dispatch KPI', icon: <FileText size={16} />, category: 'resources' },
    ...
    'manager': [
        ...
        { path: '/manager-dashboard/review-tracking', name: 'Review Tracking', icon: <FileText size={16} />, category: 'resources' },
