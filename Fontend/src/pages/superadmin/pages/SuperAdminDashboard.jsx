...
import h10 from '../../../assets/homepage/h10.jpeg';
...
const dashboardCards = [
  ...
  { label: 'Callrail', route: '/super-admin-dashboard/callrail', handwritten: true, image: h10, notificationPath: null },
];
...
export const SuperAdminDashboard = () => {
  ...
  const notificationCounts = useMemo(() => {
    ...
    return {
      ...
      // Dispatch KPI count
      '/super-admin-dashboard/dispatch-kpi': (notifications.dispatchKpi || []).filter(dkpi => {
